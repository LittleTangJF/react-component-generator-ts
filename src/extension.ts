...
export function activate(context: vscode.ExtensionContext) {
	...
	let disposable = vscode.commands.registerCommand('react-component-generator.generate-component', (e) => {
		...
		vscode.window.showInputBox().then(function(componentName) {
			...
			fs.writeFileSync(rootPath + '/' + componentName + '/' + componentName + '.js', addSnippet('reactjs'));
			fs.writeFileSync(rootPath + '/' + componentName + '/' + componentName + '.css', addSnippet('css'));
